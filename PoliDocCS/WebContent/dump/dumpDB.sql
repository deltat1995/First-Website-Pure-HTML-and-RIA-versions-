CREATE SCHEMA `poliDocCS` ;

CREATE TABLE `poliDocCS`.`folder` (
  ...
  REFERENCES `poliDocCS`.`folder` (`ID`)
  ON DELETE CASCADE
  ON UPDATE NO ACTION);

CREATE TABLE `poliDocCS`.`document` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO `poliDocCS`.`user` (`username`, `email`, `password`) VALUES ('admin', 'admin@testmail.it', "password");
INSERT INTO `poliDocCS`.`folder` (`name`, `creationDate`, `IDparent`) VALUES ('CartellaProva', '2020-05-23', NULL);
INSERT INTO `poliDocCS`.`folder` (`name`, `creationDate`, `IDparent`) VALUES ('SubCartellaProva1', '2020-05-20', 1);
INSERT INTO `poliDocCS`.`folder` (`name`, `creationDate`, `IDparent`) VALUES ('SubCartellaProva2', '2020-05-21', 1);
INSERT INTO `poliDocCS`.`folder` (`name`, `creationDate`, `IDparent`) VALUES ('SubCartellaProva3', '2020-05-22', 1);
INSERT INTO `poliDocCS`.`document` (`name`, `creationDate`, `type`, `summary`, `IDfolder`) VALUES ('DocProva','2020-05-30', 'Word Document', '
Prefacefolder
